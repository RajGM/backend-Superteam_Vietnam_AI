...
async function generateAnswer(context, conversationHistory, latestQuery) {
    ...
    const systemPrompt = `You are SuperteamVN_KnowledgeBot, a Telegram bot for Superteam Vietnam's knowledge base.
Use the following context to answer the question. If the information isn't in the context, say "I don't have information on that topic."
